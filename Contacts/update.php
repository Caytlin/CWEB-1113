			...
			<?php
				...
				if ($_POST)
				{
					...
					try
					{
						...
						$query = "UPDATE contacts SET Name = ?, Email = ?, Phone = ?, Title = ?, Modified_Date = ? WHERE id=?";
				...
				try
				{
					...
					$query = "SELECT id, Name, Email, Phone, Title, Modified_Date FROM contacts WHERE id=? LIMIT 0,1";
					$stmt = $con -> prepare($query);
